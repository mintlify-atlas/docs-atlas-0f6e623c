...
<Note>
  These are the default properties for the sign up email endpoint. With [additional fields](/concepts/typescript#additional-fields) or special plugins you can pass more properties.
</Note>
