...
<Callout type="warn">
This guide assumes you have <Link href="/installation">setup the basics</Link> of Better Auth and are ready to create your first plugin.
</Callout>
...
<Step>
## Server plugin first
Better Auth plugins operate as a pair: a <Link href="/concepts/plugins#create-a-server-plugin">server plugin</Link> and a <Link href="/concepts/plugins#creating-a-client-plugin">client plugin</Link>.
...
<Callout>
You can read more about server/client plugins in our <Link href="/concepts/plugins#creating-a-plugin">documentation</Link>.
</Callout>
...
By creating a schema here, this also allows <Link href="/api-reference/cli/overview">Better Auth’s CLI</Link> to generate the schemas required to update your database.

<Callout type="info">
You can learn more about <Link href="/concepts/plugins#schema">plugin schemas here</Link>.
</Callout>
...
To do this, we’ll utilize <Link href="/concepts/plugins#hooks">Hooks</Link>, which allows us to run code `before` or `after` an action is performed.
...
Or, use the `generate` <Link href="/api-reference/cli/overview#generate">CLI command</Link>:
```bash
...
We highly recommend you visit our <Link href="/concepts/plugins">plugins documentation</Link> to learn more information.
...
and we may add it to the <Link href="/plugins/community-plugins">community-plugins</Link> list!
