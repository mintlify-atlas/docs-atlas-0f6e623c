...
Learn more:
- [Basic Usage](/quickstart): Learn how to use the auth client to sign up, sign in, and sign out.
...
Learn more about SSO configuration in the [SSO Plugin Documentation](/plugins/overview).
