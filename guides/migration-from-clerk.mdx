...
[Two Factor](/plugins/two-factor) Plugin will allow you to add two-factor authentication to your application.
...
migrateFromClerk()
  ...
  ```
  Make sure to replace the `process.env.CLERK_SECRET_KEY` with your own Clerk secret key.
 </Step>
...
<Step>
  ...
  3. Verify the migrated data in Better Auth
  4. Keep Clerk installed until migration is complete
  </Callout>
